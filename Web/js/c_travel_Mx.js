var _Travel = {
    ...
    Init: function () {
        ...
        //alert($(".weui-navbar").offset().top);

        window.onscroll = function () {
            var scrolltop = document.documentElement.scrollTop || document.body.scrollTop;
            //alert(scrolltop);
            if (scrolltop < _Travel.Top) {
                $(".weui-navbar").removeClass("fixTopBar");
            } else {
                $(".weui-navbar").addClass("fixTopBar");
            }
        }
        
        $(".weui-navbar__item").click(function () {
            document.body.scrollTop = _Travel.Top;
        })

        setTimeout(function () {
            _Travel.Top = $(".weui-navbar__item").offset().top;
        }, 600);
    },
    getInfo: function () {
        $.showLoading();
        $.ajax(
				{
				    ...
				    success: function (o) {
				        ...
				        if (o.Return == 0) {
				            ...
				            $("#tab1").html(unescape(oi.contents));
				            $("#tab2").html(unescape(oi.content_xc));
				            $("#tab3").html(unescape(oi.content_fy));
				            $("#tab4").html(unescape(oi.content_xz));

				            $(".weui-tab").find("table").css("width", "100%");
				        }
				        else {
