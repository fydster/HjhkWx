...
public class QrCode
{
    public string toCodeImg(string msg,HttpContext c,int uid)
    {
        ...
        string fileName = DateTime.Now.ToString("yyMMddHHmmss") + uid.ToString().PadLeft(6, '0') + ".jpg";
        string ResultPath = c.Server.MapPath("/srouce/adCode/") + fileName;
