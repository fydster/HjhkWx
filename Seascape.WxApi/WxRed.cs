    ...
    */
    public class WxRed
    {
        ...
        public string SendRed(WxRed r,out string m)
        {
            string Rsa = "";
            m = "";
            r.act_name = "找个老乡，一起上大学";
            r.logo_imgurl = "http://hjhk.edmp.cc/img/logo.jpg";
            r.nick_name = "山西出行";
            r.remark = "系统测试";
            r.send_name = "山西出行";
            r.share_content = "找个老乡，一起上大学";
            r.share_imgurl = "";
            r.share_url = "";
            r.sign = "";
            r.sub_mch_id = "";
        ...
        /// <param name="RedNum"></param>
        /// <returns></returns>
        public string SendRedTest(WxRed r, out string m)
        {
            string Rsa = "";
            m = "";
            r.act_name = "找个老乡，一起上大学";
            ...
            int i = 0;
            int n = 0;
            foreach (System.Reflection.PropertyInfo p in r.GetType().GetProperties())
            {
                if (p.GetValue(r, null) != null && p.GetValue(r, null).ToString().Length > 0)
                {
                    n++;
                }
            }
            ...
            foreach (System.Reflection.PropertyInfo p in r.GetType().GetProperties())
            {
                if (p.GetValue(r, null) != null && p.GetValue(r, null).ToString().Length > 0)
                {
                    SArr[i] = p.Name + "=" + p.GetValue(r, null).ToString();
                    i++;
                }
            }
