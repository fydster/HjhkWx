...
namespace Seascape.WxApi
{
    public class Common
    {
        ...
        */
        ...
        /// </summary>
        /// <returns></returns>
        public string GetSubUser(string access_token_, string next_openid)
        {
            string JsonStr = "";
            string GetUrl = " https://api.weixin.qq.com/cgi-bin/user/get?access_token=" + access_token_ + "&next_openid=" + next_openid;
            try
            {
                JsonStr = com.seascape.tools.BasicTool.webRequest(GetUrl);
            }
            catch (Exception ex)
            {
                JsonStr = "";
        ...
        public static access_token_UserInfo Get_access_token_UserInfo(string Code)
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    access_token_UserInfo.errcode = jd["errcode"].ToString() + "-" + jd["errmsg"].ToString();
                }
            }
            catch (Exception e)
            {
